...
#        elif not has_condition2_services and not is_prematurity_ga_lt_26:
    ...
    def filter_by_distance_and_occupancy_rate(self, weight_distance: float = 1.0, weight_occupancy: float = 0.0) -> None:
        ...
        print(f"Evaluating hospitals by distance and occupancy for patient at {self.patient.gpsPos}")
        ...
        print(f"Ranked hospitals by distance and occupancy: {[h.name for h in self.available_hospitals]}")
